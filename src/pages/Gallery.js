...
function Gallery() {
  return (
    <div className="max-w-6xl mx-auto p-4 px-4 flex-1 flex flex-col justify-start">
      <h1 className="text-5xl font-bold flex items-center flex-wrap mb-6">
          <span>Gallery </span><span className="text-5xl text-[var(--accent)]">.</span>
      </h1>
